...
<template>
    ...
    <div class="table-container">
        ...
        <el-table :data="versionList" border style="width:100%" v-loading="loading" table-layout="auto" @selection-change="handleSelectionChange" >
                
                <el-table-column type="selection" width="50" />
                <el-table-column prop="id" label="編號" min-width="28"/>
                <el-table-column prop="projectName" label="專案名稱" min-width="35" show-overflow-tooltip />
                ...
                <el-table-column prop="createdTime" label="建立時間" min-width="" show-overflow-tooltip />
...
::deep(.table-container .el-table) {
    ...
    line-height: 1.6;
    min-width: 1200px;
    --el-table-bg-color: #020617 !important;
    --el-table-tr-bg-color: #020617 !important;
    --el-table-header-bg-color: #0b1120 !important;
    --el-table-border-color: rgba(148,163,184,0.45) !important;
    --el-table-border: 1px solid var(--el-table-border-color) !important;
    --el-table-text-color: #e5e7eb !important;
    --el-table-header-text-color: #f9fafb !important;
    --el-table-row-hover-bg-color: rgba(59,130,246,0.28) !important; /* hover 有明顯藍色 */
}
