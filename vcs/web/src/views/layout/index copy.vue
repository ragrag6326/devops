        ...
        <el-aside width="200px" class="left-menu">
            <el-menu>
                ...
                <el-sub-menu index="/manage">
                    <template #title>
                        <el-icon><message /></el-icon> 投顧員工管理
                    </template>
                    <el-menu-item index="/emp"><el-icon><User /></el-icon>員工管理</el-menu-item>
                    <el-menu-item index="/dept"><el-icon><HomeFilled /></el-icon>部門管理</el-menu-item>
                </el-sub-menu>

                <el-sub-menu index="member">
                    <template #title>
                        <el-icon><Avatar /></el-icon> 親帶會員管理
                    </template>
                    <el-menu-item index="1-1"><el-icon><Money /></el-icon>鑽石級會員</el-menu-item>
                    <el-menu-item index="1-2"><el-icon><User /></el-icon>白金級會員</el-menu-item>
                    <el-menu-item index="1-2"><el-icon><GoldMedal /></el-icon>黃金級會員</el-menu-item>
                </el-sub-menu>
                ...
                <el-sub-menu index="static">
                    ...
                    <el-menu-item index="1-1"><el-icon><User /></el-icon>員工訊息統計</el-menu-item>
                    <el-menu-item index="1-2"><el-icon><HomeFilled /></el-icon>會員訊息統計</el-menu-item>
                    <el-menu-item index="1-3"><el-icon><HomeFilled /></el-icon>日誌訊息統計</el-menu-item>
                </el-sub-menu>
