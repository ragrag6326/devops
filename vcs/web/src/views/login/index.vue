...
const handleLogin = async () => {
    ...
    try {
        ...
        if (result.code === 1) {
            ...
            localStorage.setItem('current_username', form.value.username);
...
<template>
  <div class="login-page">
    ...
    <!-- 中央卡片 -->
    <div class="login-card" @keydown="handleKeydown">
      <!-- 品牌區 -->
      ...
      <div class="form-body">
        ...
        <div class="btn-row">
          ...
          <button class="btn-clear" @click="handleClear" :disabled="loading">清除</button>
        </div>
      </div>

      <!-- Footer -->
      <div class="card-footer">
        © 2026 版本控制管理系統 · All rights reserved
      </div>
    </div>
  </div>
</template>
...
.orb-1 {
  ...
  background: radial-gradient(circle, rgba(79,70,229,0.30), transparent 65%);
  animation-delay: 0s;
}
.orb-2 {
...
.field-input::placeholder { color: #4a4e68; }
.field-input:focus {
  border-color: #818cf8;
...
.eye-btn:hover { color: #818cf8; background: rgba(129,140,248,0.1); }
